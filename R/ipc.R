...
#'
#' @description
#' \code{ipc()} is a convenience function to deflate nominal Brazilian Reais using the Getulio Vargas Foundation's IPC price index.
#'
...
ipc <- function(nominal_values, nominal_dates, real_date){

  deflate(nominal_values, nominal_dates, real_date, "ipc")
}
